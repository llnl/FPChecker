                               ...
                               Int_t numRanks)
{
   ...
   Int8_t nx8 = nx;
   mixedprecision_t grindTime1 =
      ((mixedprecision_t(elapsed_time)*mixedprecision_t(1e6))/locDom.cycle())/
      (mixedprecision_t(nx8)*nx8*nx8);
   mixedprecision_t grindTime2 =
      ((mixedprecision_t(elapsed_time)*mixedprecision_t(1e6))/locDom.cycle())/
      (mixedprecision_t(nx8)*nx8*nx8*numRanks);
   ...
   std::cout << std::setw(24) << mixedprecision_t(locDom.e(ElemId)) << "\n";

   mixedprecision_t   MaxAbsDiff = mixedprecision_t(0.0);
   mixedprecision_t TotalAbsDiff = mixedprecision_t(0.0);
   mixedprecision_t   MaxRelDiff = mixedprecision_t(0.0);

   for (Index_t j=0; j<nx; ++j) {
      for (Index_t k=j+1; k<nx; ++k) {
         mixedprecision_t AbsDiff =
            FABS(mixedprecision_t(locDom.e(j*nx+k)) -
                 mixedprecision_t(locDom.e(k*nx+j)));
         TotalAbsDiff  += AbsDiff;

         if (MaxAbsDiff <AbsDiff) MaxAbsDiff = AbsDiff;

         mixedprecision_t RelDiff =
            AbsDiff / mixedprecision_t(locDom.e(k*nx+j));
   ...
   std::cout << "FOM                  = " << std::setw(10)
             << mixedprecision_t(1000.0)/grindTime2 << " (z/s)\n\n";
