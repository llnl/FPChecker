...
#endif
{
   ...
   const mixedprecision_t ebase = mixedprecision_t(3.948746e+7);
   mixedprecision_t scale = mixedprecision_t(nx*m_tp)/mixedprecision_t(45.0);
   ...
   deltatime() = Real_t((mixedprecision_t(.5)*cbrt(mixedprecision_t(volo(0))))/
                        sqrt(mixedprecision_t(2.0)*einit));
