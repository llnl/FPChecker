...
static
void init_array_double(int n, int m,
		double *alpha,
		double *beta,
		double POLYBENCH_2D(C,N,N,n,n),
...
void print_array(int n,
		 DATA_TYPE POLYBENCH_2D(C,N,N,n,n),
		 double POLYBENCH_2D(C_double,N,N,n,n))
{
  int i, j;
...
static
void kernel_syrk_double(int n, int m,
		 double alpha,
		 double beta,
		 double POLYBENCH_2D(C,N,N,n,n),
		 double POLYBENCH_2D(A,N,M,n,m))
...
int main(int argc, char** argv)
{
  ...
  POLYBENCH_2D_ARRAY_DECL(C_double,double,N,N,n,n);
  POLYBENCH_2D_ARRAY_DECL(A_double,double,N,M,n,m);

  /* Initialize array(s). */
  init_array (n, m, &alpha, &beta, POLYBENCH_ARRAY(C), POLYBENCH_ARRAY(A));

  init_array_double (n, m, &alpha_double, &beta_double, POLYBENCH_ARRAY(C_double), POLYBENCH_ARRAY(A_double));
  ...
  kernel_syrk_double (n, m, alpha_double, beta_double, POLYBENCH_ARRAY(C_double), POLYBENCH_ARRAY(A_double));
  ...
  polybench_prevent_dce(print_array(n, POLYBENCH_ARRAY(C), POLYBENCH_ARRAY(C_double)));
