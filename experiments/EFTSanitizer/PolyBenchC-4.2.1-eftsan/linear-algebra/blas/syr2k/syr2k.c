...
static
void kernel_syr2k_double(int n, int m,
		  double alpha,
		  double beta,
		  double POLYBENCH_2D(C,N,N,n,n),
		  double POLYBENCH_2D(A,N,M,n,m),
...
int main(int argc, char** argv)
{
  ...
  POLYBENCH_2D_ARRAY_DECL(B_double,double,N,M,n,m);
  ...
  init_array_double (n, m, &alpha_double, &beta_double,
