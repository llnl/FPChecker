...
\title{FPChecker Tutorial Example: Mathematical Formulation and Mixed-Precision Algorithmic Changes}
\author{}
\date{}
...
\section{Purpose}
This document describes the mathematics implemented by the three programs:
\begin{itemize}
...
In this example setup, the mixed result typically matches the FP64 quadratic small root closely 
and improves variance by many orders of magnitude compared with FP32.
