...
MC_Vector GlobalFccGrid::cellCenter(Long64 iCell) const
{
   ...
   r += MC_Vector(_dx/qs_real(2.), _dy/qs_real(2.), _dz/qs_real(2.));
   return r;
}
...
MC_Vector GlobalFccGrid::nodeCoord(const Tuple4& tt) const
{
   ...
   {
      basisOffset.push_back(MC_Vector(qs_real(0.),      qs_real(0.),      qs_real(0.)     ));
      basisOffset.push_back(MC_Vector(qs_real(0.),      _dy/qs_real(2.0), _dz/qs_real(2.0)));
      basisOffset.push_back(MC_Vector(_dx/qs_real(2.0), qs_real(0.),      _dz/qs_real(2.0)));
      basisOffset.push_back(MC_Vector(_dx/qs_real(2.0), _dy/qs_real(2.0), qs_real(0.)     ));
   }
