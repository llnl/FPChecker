...
void CycleTrackingFunction( MonteCarlo *monteCarlo, MC_Particle &mc_particle, int particle_index, ParticleVault* processingVault, ParticleVault* processedVault)
{
    ...
    do
    {
        ...
        monteCarlo->_tallies->TallyCellValue( qsm::exp_(rngSample(&mc_particle.random_number_seed)) , mc_particle.domain, cell_tally_index, mc_particle.cell);
#endif   
        ...
        mc_particle.num_segments += qs_real(1.);  /* Track the number of segments this particle has
