...
def test_fp64_shadow_condition_controls_select_error():
    ...
    assert abs(expected_error + 10.0) < 1e-12
    ...
    assert min(abs(value - expected_error) for value in final_errors) < 1e-12
