...
def test_1():
    ...
    long_double_total_error_1 = 0.0
    for line in cmdOutput.decode().splitlines():
        if "Total error 1" in line:
            long_double_total_error_1 = float(line.split()[3])
            break

    long_double_total_error_2 = 0.0
    for line in cmdOutput.decode().splitlines():
        if "Total error 2" in line:
            long_double_total_error_2 = float(line.split()[3])
            break
    ...
    print('long_double_total_error 1 =', long_double_total_error_1)
    diff = abs(long_double_total_error_1 - rounding_error_1)
    print("Diff 1 =", diff)
    ...
    print('long_double_total_error 2 =', long_double_total_error_2)
    diff = abs(long_double_total_error_2 - rounding_error_2)
    print("Diff 2 =", diff)
