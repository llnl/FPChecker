...
def test_1():
    ...
    long_double_total_error = abs(float(match.group(1)))

    call_line = find_source_line("main.cpp", "double r = fp(a, b);")
    final_line = find_source_line("main.cpp", "double out = (r * 3.1415927) + 0.33333334;")
    assert call_line != -1
    assert final_line != -1
    ...
    best_error, best_delta = best_abs_error_match(data, "main.cpp", long_double_total_error)
    ...
    # End-to-end consistency: final expression error should match FP64-FP64 diff.
