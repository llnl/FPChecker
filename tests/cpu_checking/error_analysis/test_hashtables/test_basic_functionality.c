...
int main()
{
    ...
    _FPC_REGISTER_HT_UPDATE_(register_table, reg_name1, "myfunction", 0.0, error1, rel_error1, file_name, line);

    /*------------------------- Register 2 ---------------------------*/
    char reg_name2[] = "register_2";
    double error2 = 0.02;
    double rel_error2 = 0.002;
    _FPC_REGISTER_HT_UPDATE_(register_table, reg_name2, "myfunction", 0.0, error2, rel_error2, file_name, line);
    ...
    _FPC_ADDRESS_HT_UPDATE_(address_table, addr1, 0.0, error_tmp, rel_error_tmp, file_name, line);
    ...
    _FPC_ADDRESS_HT_UPDATE_(address_table, addr2, 0.0, error_tmp, rel_error_tmp, file_name, line);

    /*------------------------- Address 1 (LOAD) --------------------*/
    _FPC_FIND_ERRORS_BY_ADDRESS(address_table, addr1, &error_tmp, &rel_error_tmp);
    char reg_name3[] = "register_3_loaded";
    _FPC_REGISTER_HT_UPDATE_(register_table, reg_name3, "myfunction", 0.0, error_tmp, rel_error_tmp, file_name, line);
    /*------------------------- Print Tables ---------------------------*/
