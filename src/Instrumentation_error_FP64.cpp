...
CPUFPInstrumentation_error_fp64::CPUFPInstrumentation_error_fp64(Module *M)
    : mod(M),
      fpc_init_fp64(nullptr),
      fpc_init_args_fp64(nullptr),
      fpc_print_locations_fp64(nullptr),
      fpc_fp64_store_inst(nullptr),
      fpc_fp64_load_inst(nullptr),
      fpc_fp64_cmp_function(nullptr),
      fpc_fp64_calculate_function(nullptr),
      fpc_fp64_phi_function(nullptr),
      fpc_fp64_branch_function(nullptr),
      fpc_fp64_memcpy_function(nullptr),
      fpc_fp64_push_ret_error(nullptr),
      ...
      fpc_fp64_math_error(nullptr)
{
  ...
  for (auto F = M->begin(), e = M->end(); F != e; ++F)
  {
    ...
    {
      confFunction(f, &fpc_init_fp64, GlobalValue::LinkageTypes::LinkOnceODRLinkage,
                   "_FPC_INIT_FPCHECKER");
    }
    if (f->getName().str().find("_FPC_INIT_ARGS_FPCHECKER") !=
        std::string::npos)
    {
      confFunction(f, &fpc_init_args_fp64,
                   GlobalValue::LinkageTypes::LinkOnceODRLinkage,
                   "_FPC_INIT_ARGS_FPCHECKER");
    }
    if (f->getName().str().find("_FPC_PRINT_LOCATIONS_") != std::string::npos)
    {
      confFunction(f, &fpc_print_locations_fp64,
                   GlobalValue::LinkageTypes::LinkOnceODRLinkage,
                   "_FPC_PRINT_LOCATIONS_FP64");
    }
    if (f->getName().str().find("_FPC_FP64_STORE_INST_") != std::string::npos)
    {
      confFunction(f, &fpc_fp64_store_inst,
                   GlobalValue::LinkageTypes::LinkOnceODRLinkage,
                   "_FPC_FP64_STORE_INST_");
    }
    if (f->getName().str().find("_FPC_FP64_LOAD_INST_") != std::string::npos)
    {
      confFunction(f, &fpc_fp64_load_inst,
                   GlobalValue::LinkageTypes::LinkOnceODRLinkage,
                   "_FPC_FP64_LOAD_INST_");
    }
    if (f->getName().str().find("_FPC_FP64_CMP_") != std::string::npos)
    {
      confFunction(f, &fpc_fp64_cmp_function,
                   GlobalValue::LinkageTypes::LinkOnceODRLinkage,
                   "_FPC_FP64_CMP_");
    }
    if (f->getName().str().find("_FPC_FP64_CALCULATE_ERROR_") != std::string::npos)
    {
      confFunction(f, &fpc_fp64_calculate_function,
                   GlobalValue::LinkageTypes::LinkOnceODRLinkage,
                   "_FPC_FP64_CALCULATE_ERROR_");
    }
    if (f->getName().str().find("_FPC_FP64_PHI_") != std::string::npos)
    {
      confFunction(f, &fpc_fp64_phi_function,
                   GlobalValue::LinkageTypes::LinkOnceODRLinkage,
                   "_FPC_FP64_PHI_");
    }
    if (f->getName().str().find("_FPC_FP64_BRANCH_") != std::string::npos)
    {
      confFunction(f, &fpc_fp64_branch_function,
                   GlobalValue::LinkageTypes::LinkOnceODRLinkage,
                   "_FPC_FP64_BRANCH_");
    }
    if (f->getName().str().find("_FPC_FP64_MEMCPY_INST_") != std::string::npos)
    {
      confFunction(f, &fpc_fp64_memcpy_function,
                   GlobalValue::LinkageTypes::LinkOnceODRLinkage,
                   "_FPC_FP64_MEMCPY_INST_");
    }
    if (f->getName().str().find("_FPC_FP64_PUSH_RET_ERROR_") != std::string::npos)
    {
      confFunction(f, &fpc_fp64_push_ret_error,
                   GlobalValue::LinkageTypes::LinkOnceODRLinkage,
                   "_FPC_FP64_PUSH_RET_ERROR_");
    }
    if (f->getName().str().find("_FPC_FP64_POP_RET_ERROR_") != std::string::npos)
    {
      confFunction(f, &fpc_fp64_pop_ret_error,
                   GlobalValue::LinkageTypes::LinkOnceODRLinkage,
                   "_FPC_FP64_POP_RET_ERROR_");
    }
    if (f->getName().str().find("_FPC_FP64_PUSH_ARG_ERROR_") != std::string::npos)
    {
      confFunction(f, &fpc_fp64_push_arg_error,
                   GlobalValue::LinkageTypes::LinkOnceODRLinkage,
                   "_FPC_FP64_PUSH_ARG_ERROR_");
    }
    if (f->getName().str().find("_FPC_FP64_POP_ARG_ERROR_") != std::string::npos)
    {
      confFunction(f, &fpc_fp64_pop_arg_error,
                   GlobalValue::LinkageTypes::LinkOnceODRLinkage,
                   "_FPC_FP64_POP_ARG_ERROR_");
    }
    if (f->getName().str().find("_FPC_FP64_MATH_ERROR_") != std::string::npos)
    {
      confFunction(f, &fpc_fp64_math_error,
                   GlobalValue::LinkageTypes::LinkOnceODRLinkage,
    ...
    SET_ODR_LIKAGE("_FPC_FP64_CMP_")
    SET_ODR_LIKAGE("_FPC_FP64_CALCULATE_ERROR_")
    SET_ODR_LIKAGE("_FPC_FP64_PHI_")
    SET_ODR_LIKAGE("_FPC_FP64_BRANCH_")
    ...
    SET_ODR_LIKAGE("_FPC_FP64_MEMCPY_INST_")
    SET_ODR_LIKAGE("_FPC_FP64_PUSH_RET_ERROR_")
    SET_ODR_LIKAGE("_FPC_FP64_POP_RET_ERROR_")
    ...
    SET_ODR_LIKAGE("_FPC_REGISTER_HT_CREATE_FP64_")
    SET_ODR_LIKAGE("_FPC_HT_HASH_ADDRESS_FP64_")
    SET_ODR_LIKAGE("_FPC_HT_HASH_REGISTER_FP64_")
    SET_ODR_LIKAGE("_FPC_ADDRESS_HT_NEWPAIR_FP64_")
    SET_ODR_LIKAGE("_FPC_REGISTER_HT_NEWPAIR_FP64_")
  ...
  addr_table = mod->getGlobalVariable("_FPC_ADDRESS_HT_FP64_", true);
  ...
  reg_table = mod->getGlobalVariable("_FPC_REGISTER_HT_FP64_", true);
  ...
  ret_error_stack = mod->getGlobalVariable("_FPC_RET_ERR_STACK_FP64_", true);
  ...
  ret_stack_top = mod->getGlobalVariable("_FPC_RET_STACK_TOP_FP64_", true);
  ...
  ret_func_stack = mod->getGlobalVariable("_FPC_RET_FUNC_STACK_FP64_", true);
  ...
  arg_buf_count = mod->getGlobalVariable("_FPC_ARG_BUF_COUNT_FP64_", true);
...
// ********************************************************************
void CPUFPInstrumentation_error_fp64::instrumentFunctionErrorAnalysis(Function *f, long int *insrtrumented_instructions)
{
  ...
  assert((fpc_fp64_calculate_function != nullptr) && "Function not initialized!");
  assert((fpc_fp64_load_inst != nullptr) && "Function not initialized!");
  assert((fpc_fp64_store_inst != nullptr) && "Function not initialized!");
  assert((fpc_fp64_cmp_function != nullptr) && "Function not initialized!");
  assert((fpc_fp64_phi_function != nullptr) && "Function not initialized!");
  assert((fpc_fp64_branch_function != nullptr) && "Function not initialized!");
  assert((fpc_fp64_memcpy_function != nullptr) && "Function not initialized!");
  assert((fpc_fp64_push_ret_error != nullptr) && "Function not initialized!");
  assert((fpc_fp64_pop_ret_error != nullptr) && "Function not initialized!");
  assert((fpc_fp64_push_arg_error != nullptr) && "Function not initialized!");
  assert((fpc_fp64_pop_arg_error != nullptr) && "Function not initialized!");
  assert((fpc_fp64_math_error != nullptr) && "Function not initialized!");
...
/*   if (functionCallsFunctionWithFloatingPointValues(f))
  ...
  // ============= Pop argument errors into callee parameters ===================
  {
    ...
    //   if (arg.getType()->isFloatTy() || arg.getType()->isDoubleTy())
         if (arg.getType()->isDoubleTy())
      {
        ...
        popArgs.push_back(&arg);   // runtime fallback value
        ...
        CallInst *hookCall = popBuilder.CreateCall(fpc_fp64_pop_arg_error, popArgs_ref);
  ...
  for (auto bb = f->begin(), end = f->end(); bb != end; ++bb)
  {
    for (auto i = bb->begin(), bend = bb->end(); i != bend; ++i)
    {
      ...
      if (llvm::isa<llvm::StoreInst>(inst))
      {
        ...
        // if ((storedValue->getType()->isFloatTy() || storedValue->getType()->isDoubleTy()) && !llvm::isa<llvm::Constant>(storedValue))
         if ((storedValue->getType()->isDoubleTy()) && !llvm::isa<llvm::Constant>(storedValue))
        {
          ...
          callInst = builder.CreateCall(fpc_fp64_store_inst, args_ref);
          (*insrtrumented_instructions)++;
      ...
      if (auto *loadInst = llvm::dyn_cast<llvm::LoadInst>(inst))
      {
        ...
        if (loadInst->getType()->isDoubleTy())
        {
          ...
          *------------------------------------------------------------------*/
          ...
          ArrayRef<Value *> args_ref(args);
          CallInst *callInst = nullptr;
          callInst = builder.CreateCall(fpc_fp64_load_inst, args_ref);
          (*insrtrumented_instructions)++;
      ...
      */
      if (auto *II = llvm::dyn_cast<llvm::IntrinsicInst>(inst))
      {
            ...
            id == llvm::Intrinsic::memmove)
        {
          ...
          ArrayRef<Value *> args_ref(args);
          CallInst *callInst = nullptr;
          callInst = builder.CreateCall(fpc_fp64_memcpy_function, args_ref);
          (*insrtrumented_instructions)++;
      ...
      if (auto *callInst = llvm::dyn_cast<llvm::CallBase>(inst))
      {
        ...
        if (calledFunc)
        {
          ...
          if (isMPIAllreduce && callInst->arg_size() >= 3)
          {
            ...
            // Value *byteSize = builder.CreateMul(countI64, ConstantInt::get(builder.getInt64Ty(), 4));
            Value *byteSize = builder.CreateMul(countI64, ConstantInt::get(builder.getInt64Ty(), 8)); //  8 for double precision
            ...
            ArrayRef<Value *> args_ref(args);
            CallInst *hookCall = builder.CreateCall(fpc_fp64_memcpy_function, args_ref);
            (*insrtrumented_instructions)++;
          ...
          else if (isMPIReduce && callInst->arg_size() >= 3)
          {
            ...
            Value *byteSize = builder.CreateMul(countI64,
                ConstantInt::get(builder.getInt64Ty(), 8)); //  8 for double precision
          ...
          else if (isMPIBcast && callInst->arg_size() >= 2)
          {
            ...
            Value *countI64 = builder.CreateZExtOrTrunc(count, builder.getInt64Ty());
            Value *byteSize = builder.CreateMul(countI64,
                ConstantInt::get(builder.getInt64Ty(), 8));
      ...
      {
        if (cmpInst->getOperand(0)->getType()->isDoubleTy() &&
            cmpInst->getOperand(1)->getType()->isDoubleTy())
        {
          int predicateCode = -1;
        ...
        if (!isIntrinsic && !isFPCInternal && !isMathCall)
        {
          ...
          for (unsigned argIdx = 0; argIdx < callInst->arg_size(); ++argIdx)
          {
            ...
            if (argVal->getType()->isDoubleTy())
            {
              ...
              CallInst *hookCall = pushBuilder.CreateCall(fpc_fp64_push_arg_error, pushArgs_ref);
              (*insrtrumented_instructions)++;
      ...
      if (auto *callInst = llvm::dyn_cast<llvm::CallBase>(inst))
      {
        if (callInst->getType()->isDoubleTy())
        {
          ...
          else
          {
            ...
            ArrayRef<Value *> args_ref(args);
            CallInst *hookCall = builder.CreateCall(fpc_fp64_pop_ret_error, args_ref);
            (*insrtrumented_instructions)++;
      ...
      {
        std::string mathName;
        if (callInst->getType()->isDoubleTy() && isSupportedMathCall(callInst, mathName))
        {
          BasicBlock::iterator nextInst(inst);
          ++nextInst;
          IRBuilder<> builder(&(*nextInst));
          ...
          for (int pi = fpCount; pi < 3; ++pi)
            // fpArgs[pi] = ConstantFP::get(builder.getFloatTy(), 0.0f);
               fpArgs[pi] = ConstantFP::get(builder.getDoubleTy(), 0.0);
        ...
        //   }
        // Commenting out the above loop since we are now using double precision for the hook signature
...

          {
            ...
            ArrayRef<Value *> args_ref(args);
            CallInst *hookCall = builder.CreateCall(fpc_fp64_math_error, args_ref);
            (*insrtrumented_instructions)++;
    ...
    //        (inst->getNumOperands() >= 2 && inst->getOperand(1)->getType()->isFloatTy())))
        if ((isFPOperationWithError(inst) ||
            (inst->getOpcode() == Instruction::FNeg) ||
            (inst->getOpcode() == Instruction::Select)) &&
            (inst->getType()->isDoubleTy() ||
            (inst->getNumOperands() > 0 && inst->getOperand(0)->getType()->isDoubleTy()) ||
            (inst->getNumOperands() >= 2 && inst->getOperand(1)->getType()->isDoubleTy())))
        {
      ...
      if (auto *retInst = llvm::dyn_cast<llvm::ReturnInst>(inst))
      {
        ...
        if (retVal && retVal->getType()->isDoubleTy()) //Codex suggestion for tracking nullptr 
        {
          ...
          ArrayRef<Value *> args_ref(args);
          CallInst *hookCall = builder.CreateCall(fpc_fp64_push_ret_error, args_ref);
          (*insrtrumented_instructions)++;
    ...
    for (auto i = bb->begin(), bend = bb->end(); i != bend; ++i)
    {
      ...
      if (auto *phiInst = llvm::dyn_cast<llvm::PHINode>(inst))
      {
        if (phiInst->getType()->isDoubleTy())
        {
          ...
          args.push_back(phiInst);   // runtime fallback value
          args.push_back(builder.CreateGlobalStringPtr(f->getName()));
          ArrayRef<Value *> args_ref(args);
          CallInst *callInst = builder.CreateCall(fpc_fp64_phi_function, args_ref);
          (*insrtrumented_instructions)++;
          assert(callInst && "Invalid call instruction!");
  ...
  for (auto bb = f->begin(), end = f->end(); bb != end; ++bb)
  {
    ...
    if (terminator && llvm::isa<llvm::BranchInst>(terminator))
    {
      ...
      ArrayRef<Value *> args_ref(args);
      CallInst *callInst = builder.CreateCall(fpc_fp64_branch_function, args_ref);
      (*insrtrumented_instructions)++;
...
bool CPUFPInstrumentation_error_fp64::selectedBasedOnCondition(Instruction *inst,
                                                          Function *f,
...
bool CPUFPInstrumentation_error_fp64::isCmpEqual(const Instruction *inst)
{
...
bool CPUFPInstrumentation_error_fp64::isFMAOperation(const Instruction *inst)
{
...
bool CPUFPInstrumentation_error_fp64::isFPOperation(const Instruction *inst)
{
...
bool CPUFPInstrumentation_error_fp64::isFPOperationWithError(const Instruction *inst)
{
...
bool CPUFPInstrumentation_error_fp64::isDoubleFPOperation(const Instruction *inst)
{
...
bool CPUFPInstrumentation_error_fp64::isSingleFPOperation(const Instruction *inst)
{
  if (!isFPOperation(inst))
    return false;
...
void CPUFPInstrumentation_error_fp64::setFakeDebugLocation(Instruction *old_inst,
...
bool CPUFPInstrumentation_error_fp64::functionisAnnotated(const Function *f, const char *annotation)
{
...
bool CPUFPInstrumentation_error_fp64::functionCallsFunctionWithFloatingPointValues(const Function *f)
{
...
Instruction *CPUFPInstrumentation_error_fp64::firstInstrution()
{
...
void CPUFPInstrumentation_error_fp64::instrumentMainFunction(Function *f)
{
  /// ----------------- BEGIN --------------------------
  ...
  if (f->arg_size() == 2)
  {
    ...
    ArrayRef<Value *> args_ref(args);
    callInst = builder.CreateCall(fpc_init_args_fp64, args_ref);
  }
  else
  {
    // ArrayRef<Value *> args_ref(args);
    callInst = builder.CreateCall(fpc_init_fp64, args);
  }
  assert(callInst && "Invalid call instruction!");
  ...
  for (auto bb = f->begin(), end = f->end(); bb != end; ++bb)
  {
    for (auto i = bb->begin(), iend = bb->end(); i != iend; ++i)
    {
      ...
      if (isa<ReturnInst>(inst) || isa<ResumeInst>(inst))
      {
        ...
        ArrayRef<Value *> args_ref(args);
        IRBuilder<> builder(inst);
        auto callInst = builder.CreateCall(fpc_print_locations_fp64, args_ref);
        assert(callInst && "Invalid call instruction!");
        callInst->setDebugLoc(inst->getDebugLoc());
        assert(callInst->getDebugLoc() && "Invalid debug loc! Please use -g");
      }
...
/* True if this fcmp directly feeds a branch/select/call. */
